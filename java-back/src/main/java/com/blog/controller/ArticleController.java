...
public class ArticleController {
	...
	@RequestMapping(value="/readingNumberAddOne/{articleId}",method = RequestMethod.GET)
	public @ResponseBody Integer readingNumberAddOne(@PathVariable Integer articleId){
		//文章阅读数+1
